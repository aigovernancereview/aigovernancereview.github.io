  ...
  <>
    ...
    <Layout>
      <article>
        ...
        <p>
          In that, AI is the linchpin accelerating and amplifying the development of all the fields
          of research. With the rapid development of machine learning in recent years, the
          governance of the technology has gradually come under the spotlight.
        </p>
        <p>
          It was once possible to keep track of all the research institutes, conferences and policy
          developments. In 2019, this became an arduous task for researchers and policymakers. To
          help separate the signal from the noise for interested stakeholders, we decided to invite
          some of the world renowned experts to review the progress in AI governance during the
          year.
        </p>
      </article>
      <article>
        ...
        <p>
          ...
          experts covers a wide range of regional developments and perspectives, including those in
          the United States, Europe and Asia. For a full list of contributors, see the report.
        </p>
      </article>
      <article>
        <h2>Feedback</h2>
